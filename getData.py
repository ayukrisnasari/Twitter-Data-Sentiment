    ...
    while len(searched_tweets) < max_tweets:
        ...
        try:
            new_tweets = api.search(q=query, count=remaining_tweets,
				                    ...
				                    max_id=str(max_id-1), tweet_mode='extended', lang='id')
#                                    geocode=geocode)
...
def main():
    ...
    ''' search variables: '''
    search_phrases = ['Maudy Ayunda', 'Cinta Laura','Agnes Mo', 'Sherina Munaf','Isyana', 'Dian Sastro',
                        'Najwa Shihab', 'Bu Risma','Susi Pudjiastuti','Sri Mulyani',
                        'Nadiem Makarim','Deddy Corbuzier','Ahok', 'Raffi Ahmad','Ganjar Pranowo',
                         'anies baswedan', 'chef juna', 'dr tirta', 'Jerome Polin', 'Bintang Emon'
                        ]
    time_limit = 1.5                           # runtime limit in hours,
    max_tweets = 100                           # number of tweets per search (will be
                                               # iterated over) - maximum is 100
    min_days_old, max_days_old = 3,8     # search limits e.g., from 7 to 8
